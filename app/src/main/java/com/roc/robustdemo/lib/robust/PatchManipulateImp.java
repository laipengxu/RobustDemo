package com.roc.robustdemo.lib.robust;
...
public class PatchManipulateImp extends PatchManipulate {
    ...
    protected List<Patch> fetchPatchList(Context context) {
        ...
        patch.setLocalPath(context.getApplicationContext().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath() + File.separator + "robust" + File.separator + "patch");
        ...
        //请注意这里的设置
        patch.setPatchesInfoImplClassFullName("com.roc.robustdemo.patch.PatchesInfoImpl");
    ...
    protected boolean verifyPatch(Context context, Patch patch) {
        ...
        //放到app的私有目录
        //noinspection ConstantConditions
        patch.setTempPath(context.getApplicationContext().getExternalCacheDir().getAbsolutePath() + File.separator + "patch");
